...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/mnt/d/develop/android/workspace/FFmpeg4Android/build_script/build/arm --enable-cross-compile --disable-runtime-cpudetect --enable-asm --arch=arm --target-os=android --cc=/mnt/d/develop/android/dev-tools/sdk/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc --cross-prefix=/mnt/d/develop/android/dev-tools/sdk/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi- --disable-stripping --nm= --sysroot=/mnt/d/develop/android/dev-tools/sdk/android-ndk-r15c/platforms/android-21/arch-arm --extra-cflags='-I/mnt/d/develop/android/workspace/FFmpeg4Android/build_script/libx264/build/arm/include  -I/mnt/d/develop/android/workspace/FFmpeg4Android/build_script/fdk-aac-0.1.5/build/arm/include ' --extra-ldflags='-L/mnt/d/develop/android/workspace/FFmpeg4Android/build_script/fdk-aac-0.1.5/build/arm/lib -L/mnt/d/develop/android/workspace/FFmpeg4Android/build_script/libx264/build/arm/lib' --enable-gpl --enable-shared --disable-static --enable-version3 --enable-pthreads --enable-small --disable-vda --disable-iconv --disable-encoders --enable-libx264 --enable-neon --enable-yasm --enable-libfdk_aac --enable-encoder=libx264 --enable-encoder=libfdk_aac --enable-encoder=mjpeg --enable-encoder=png --enable-nonfree --enable-muxers --enable-muxer=mov --enable-muxer=mp4 --enable-muxer=h264 --enable-muxer=avi --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=h264 --enable-decoder=mpeg4 --enable-decoder=mjpeg --enable-decoder=png --disable-demuxers --enable-demuxer=image2 --enable-demuxer=h264 --enable-demuxer=aac --enable-demuxer=avi --enable-demuxer=mpc --enable-demuxer=mov --enable-demuxer=mpegts --disable-parsers --enable-parser=aac --enable-parser=ac3 --enable-parser=h264 --enable-protocols --enable-zlib --enable-avfilter --disable-outdevs --disable-ffprobe --disable-ffplay --disable-ffmpeg --disable-ffserver --disable-debug --disable-ffprobe --disable-ffplay --disable-ffmpeg --disable-postproc --disable-avdevice --disable-symver --disable-stripping --extra-cflags='-O3 -fpic -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 -mfloat-abi=softfp -mfpu=vfp -marm -march=armv6   -O3 -Wall -pipe -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID  ' --extra-ldflags=
prefix=/mnt/d/develop/android/workspace/FFmpeg4Android/build_script/build/arm
...
ARCH=arm
INTRINSICS=none
CC=/mnt/d/develop/android/dev-tools/sdk/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
CXX=/mnt/d/develop/android/dev-tools/sdk/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-g++
AS=/mnt/d/develop/android/dev-tools/sdk/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
OBJCC=/mnt/d/develop/android/dev-tools/sdk/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
LD=/mnt/d/develop/android/dev-tools/sdk/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
DEPCC=/mnt/d/develop/android/dev-tools/sdk/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/mnt/d/develop/android/dev-tools/sdk/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=/mnt/d/develop/android/dev-tools/sdk/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-ar
ARFLAGS=rcD
AR_O=$@
RANLIB=/mnt/d/develop/android/dev-tools/sdk/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-ranlib -D
STRIP=echo skipping strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/mnt/d/develop/android/dev-tools/sdk/android-ndk-r15c/platforms/android-21/arch-arm -isysroot /mnt/d/develop/android/dev-tools/sdk/android-ndk-r15c/platforms/android-21/arch-arm -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -I/mnt/d/develop/android/workspace/FFmpeg4Android/build_script/libx264/build/arm/include -I/mnt/d/develop/android/workspace/FFmpeg4Android/build_script/fdk-aac-0.1.5/build/arm/include -O3 -fpic -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 -mfloat-abi=softfp -mfpu=vfp -marm -march=armv6 -O3 -Wall -pipe -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -march=armv6 -std=c99 -fomit-frame-pointer -fPIC -marm -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++98
OBJCFLAGS=  
ASFLAGS=  -I/mnt/d/develop/android/workspace/FFmpeg4Android/build_script/libx264/build/arm/include -I/mnt/d/develop/android/workspace/FFmpeg4Android/build_script/fdk-aac-0.1.5/build/arm/include -O3 -fpic -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 -mfloat-abi=softfp -mfpu=vfp -marm -march=armv6 -O3 -Wall -pipe -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -march=armv6 -fPIC
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
WINDRES=/mnt/d/develop/android/dev-tools/sdk/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-windres
DEPWINDRES=/mnt/d/develop/android/dev-tools/sdk/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
DOXYGEN=doxygen
LDFLAGS= -L/mnt/d/develop/android/workspace/FFmpeg4Android/build_script/fdk-aac-0.1.5/build/arm/lib -L/mnt/d/develop/android/workspace/FFmpeg4Android/build_script/libx264/build/arm/lib   --sysroot=/mnt/d/develop/android/dev-tools/sdk/android-ndk-r15c/platforms/android-21/arch-arm -isysroot /mnt/d/develop/android/dev-tools/sdk/android-ndk-r15c/platforms/android-21/arch-arm -march=armv6 -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
